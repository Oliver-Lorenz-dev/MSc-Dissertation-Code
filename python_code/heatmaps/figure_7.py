...
# heatmap of key developmental genes in normal prostate v iPSC33
...
def check_gene_expression(df):
    ...
    ax.set_title('Expression levels of key genes in Normal Prostate v Embryonic', fontweight = 'bold')
    
check_gene_expression('normalvSC_total.csv')
